...
<head>
    ...
    <title>SocialX | Chi tiết bài đăng</title>
                                    ...
                                    <li class="mb-2 d-flex align-items-start justify-content-between">
                                        <div class="modal fade" id="deleteCommentModal_${comment.id}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalLabel1">Xoá bình
                                                            luận</h1>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                                aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        Thao tác này không thể hoàn tác. Bạn có chắc chắn muốn xoá bình
                                                        luận này không?
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn" data-bs-dismiss="modal">Huỷ
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form action="post/${post.id}/comment/${comment.id}/edit"
                                                          method="post">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="exampleModalLabel2">Chỉnh
                                                                sửa
                                                                bình
                                                                luận</h1>
                                                ...
                                                <span class="dropdown-toggle" data-bs-toggle="dropdown"
                                                    ...
                                                    <div class="dropdown-menu m-0 p-0">
                                                        <c:if test="${comment.user.id == user.id}">
                                                            <a class="dropdown-item p-3" type="button"
                                                               ...
                                                               data-bs-target="#editCommentModal_${comment.id}">
                                                                <div class="d-flex align-items-top">
                                                                    ...
                                                                    <div class="data ms-2">
                                                                        <h6>Chỉnh sửa</h6>
                                                                        <p class="mb-0">Chỉnh sửa nội dung bình luận</p>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                        </c:if>
                                                        <a class="dropdown-item p-3" type="button"
                                                           ...
                                                           data-bs-target="#deleteCommentModal_${comment.id}">
                                                            <div class="d-flex align-items-top">
                                                                ...
                                                                <div class="data ms-2">
                                                                    <h6>Xoá</h6>
                                                                    <p class="mb-0">Xoá bình luận khỏi hệ thống</p>
                                                                </div>
                                                            </div>
                                                        </a>
                                                    </div>
