                        ...
                        <ul id="ui-elements" class="iq-submenu collapse"
                            ...
                            <li class="">
                                ...
                                <ul id="tables" class="iq-submenu collapse" data-bs-parent="#ui-elements">
                                    ...
                                    <li class="">
                                        <a href="../dashboard/table-editable.html"><i class="ri-refund-line"></i>Editable
                                            Table</a></li>
                                </ul>
                            </li>
                            <li class="">
                                ...
                                <ul id="icons" class="iq-submenu collapse" data-bs-parent="#ui-elements">
                                    <li class="">
                                        <a href="../dashboard/icon-fontawesome-5.html"><i class="ri-facebook-fill"></i>Font
                                            Awesome 5</a>
                                    </li>
                                    <li class="">
                        ...
                        <ul id="pages" class="iq-submenu collapse" data-bs-parent="#iq-sidebar-toggle">
                            <li class="">
                                ...
                                <ul id="authentication" class="iq-submenu collapse" data-bs-parent="#pages">
                                    ...
                                    <li class="">
                                        <a href="../dashboard/pages-recoverpw.html"><i class="ri-record-mail-line"></i>Recover
                                            Password</a>
                                    </li>
                                    <li class="">
                                        <a href="../dashboard/pages-confirm-mail.html"><i class="ri-file-code-line"></i>Confirm
                                            Mail</a>
                                    </li>
                                    <li class="">
                            ...
                            <li class="">
                                ...
                                <ul id="extra-pages" class="iq-submenu collapse" data-bs-parent="#pages">
                                    ...
                                    <li class="">
                                        <a href="../dashboard/pages-error.html"><i class="ri-error-warning-line"></i>Error
                                            404</a>
                                    </li>
                                    <li class="">
                                    ...
                                    <li class="">
                                        <a href="../dashboard/pages-comingsoon.html"><i class="ri-mastercard-line"></i>Coming
                                            Soon</a>
                                    </li>
                                    <li class="">
                            ...
                            <div class="profile-header">
                                ...
                                <div class="user-detail text-center mb-3">
                                    ...
                                    <div class="profile-detail">
                                        <h3 class="">${targetUser.lastName} ${targetUser.firstName}</h3>
                                    </div>
                                </div>
                                            ...
                                            <div class="card-body">
                                                <div class="post-item">
                                                                ...
                                                                <div class="d-flex justify-content-between flex-wrap">
                                                                    <div class="">
                                                                        <h5 class="mb-0 d-inline-block"><a href="#"
                                                                                                           class="">Bni
                                                                            Cyst</a></h5>
                                                                        <p class="ms-1 mb-0 d-inline-block">Add New
                                                                            Post</p>
                                                   ...
                                                   <i class="ri-more-fill"></i>
                                                    ...
                                                    <div class="user-post">
                                                        <a href="#"><img src="images/page-img/p1.jpg"
                                                ...
                                                <div class="post-item">
                                                   ...
                                                   <i class="ri-more-fill"></i>
                                                    ...
                                                    <div class="user-post">
                                                        <a href="#"><img src="images/page-img/p3.jpg"
                                                                         alt="post-image" class="img-fluid w-100"/></a>
                                                    </div>
                                                    <div class="comment-area mt-3">
                                                        <div class="d-flex justify-content-between align-items-center flex-wrap">
